<template>
  <div class="about-container">
    <!-- Header Section -->
    <header class="header">
      <h1 class="title">關於 EasyTTS</h1>
      <p class="subtitle">文字轉語音解決方案</p>
    </header>
    ...
    <section class="intro">
      <div class="intro-content">
        ...
        <p>
          EasyTTS
          是一個開源工具，致力於將文本輕鬆轉換為自然流暢的語音輸出，特別適合文字和長篇文章的有聲化需求。
        </p>
      </div>
    </section>
    ...
    <section class="team">
      ...
      <div class="team-content">
        ...
        <p>EasyTTS 是一個實驗性的項目，旨在提供簡單高效的語音轉換體驗。</p>
        <p>喜歡的話，歡迎為這個項目點讚或分享支持！</p>
      </div>
    </section>
  </div>
</template>
...
<script setup>
import { ChatDotRound, Reading, Microphone, Setting, User } from "@element-plus/icons-vue";
</script>
